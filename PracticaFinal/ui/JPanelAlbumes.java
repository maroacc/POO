              ...
              public void actionPerformed(ActionEvent e)
                {
                  ...
                  JScrollPaneCanciones jventanaCancionesDeArtista = new JScrollPaneCanciones(jventana, album.getNombre(),
                                                                    album.getImageIcon(), album.getCanciones(),
                                                                    jventana.COLOR_SECUNDARIO);
                  jventana.add(jventanaCancionesDeArtista, BorderLayout.CENTER);
                  jventana.setVentanaActual(jventanaCancionesDeArtista);
                  jventana.BTN_ALBUMES.setForeground(MiJButton.COLOR_DEFECTO);
                  jventana.BTN_ALBUMES.setFont(JVentana.FONT_TITLE);
                  jventana.repaint();
