...
public class JScrollPaneArtistas extends JScrollPane

  { public JScrollPaneArtistas(JVentana jventana, String titulo, Collection collection, Color color)
      { super(new JPanelArtistas(jventana, titulo, collection, color));
