...
{ public static final ImageIcon iconImage = new ImageIcon("PracticaFinal/iconos/TMariajoMahGrande.png");
  ...
  private MiJButton btnAlbumes = new MiJButton("�lbumes", new ImageIcon("PracticaFinal/iconos/compact-disc.png"));
  ...
  private void iniciarComponentes()
    { //Establece el Layout como BorderLayout
      ...
      //A�adir los paneles de la ventana
  ...
  private void setPanelSuperior()
    { MiJPanel panelSuperior = new MiJPanel(this.COLOR_FONDO);  //Contiene el bot�n de Incio, el buscador y el nombre de usuario
  ...
  private void setPanelIzquierdo()
    { MiJPanel panelIzquierdo = new MiJPanel(this.COLOR_FONDO); //Contiene las opciones del men� y la car�tula del disco en reproducci�n
  ...
  private void setPanelInferior()
    { MiJPanel panelInferior = new MiJPanel(this.COLOR_SECUNDARIO); //Contiene la canci�n en reproducci�n
      ...
      //Nombre de la cancion y del artista en reproducci�n
      ...
      //Botones para controlar la canci�n en reproducci�n
